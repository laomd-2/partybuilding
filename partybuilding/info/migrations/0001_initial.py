# Generated by Django 2.1.5 on 2019-02-11 10:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.Branch', verbose_name='支部ID')),
            ],
            options={
                'verbose_name': '成员信息',
        ...
        migrations.AddField(
            model_name='branch',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.School', verbose_name='学院ID'),
        ),
    ]
