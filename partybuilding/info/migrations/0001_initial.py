# Generated by Django 2.1.5 on 2019-02-06 19:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_name', models.CharField(max_length=50, unique=True, verbose_name='支部名称（全称）')),
            ],
            options={
                'verbose_name': '支部',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.Branch', verbose_name='支部')),
            ],
            options={
                'verbose_name': '个人信息',
